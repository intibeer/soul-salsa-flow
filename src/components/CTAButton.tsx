...
const CTAButton = ({ to, children, variant = "primary", external = false, size = "md" }: CTAButtonProps) => {
  ...
  const styles = {
    primary: `${base} bg-orange-gradient text-primary-foreground shadow-orange-glow hover:-translate-y-0.5 hover:shadow-[0_12px_40px_-8px_hsl(25_100%_47%_/_0.6)] active:translate-y-0`,
