...
import { events, AppEvent } from "@/data/events";

const typeStyles: Record<string, string> = {
  Social: "bg-warm-peach text-primary",
  Special: "bg-orange-100 text-orange-700",
  Event: "bg-warm-cream text-orange-700",
  Class: "bg-warm-cream text-orange-700",
};

const bachataHosts =
  events.find((e) => e.id === "bachata-tuesdays")?.hosts ?? [];
const salsaConnect = events.find((e) => e.id === "salsa-connect-earth-day");
const bachata = events.find((e) => e.id === "bachata-tuesdays");

const Events = () => {
  const [activeEvent, setActiveEvent] = useState<AppEvent | null>(null);
  const openModal = (e: AppEvent) => setActiveEvent(e);
    ...
    <Layout>
      ...
      {salsaConnect && (
        <section className="relative py-24 px-6 overflow-hidden">
          <div
            ...
            style={{
              background:
                "radial-gradient(circle, hsl(var(--orange-300)), transparent 70%)",
            }}
            aria-hidden="true"
          />
              ...
              <div className="relative grid md:grid-cols-[1.1fr_1fr] gap-0">
                <div className="p-10 md:p-14">
                  ...
                  <h2 className="font-statement text-5xl md:text-6xl text-primary-foreground leading-[0.95] tracking-tight mb-3 uppercase">
                    Salsa
                    <span className="normal-case font-script text-[1.2em] ml-2">
                      &amp;
                    </span>
                    <br />
                    Connect
                  ...
                  <p className="font-body text-primary-foreground/95 leading-relaxed mb-2">
                    <span className="font-bold">
                      {salsaConnect.fullDate || salsaConnect.date}
                    </span>{" "}
                    · Happy Earth Day 🌎
                  </p>
                  <p className="font-body text-primary-foreground/85 mb-6">
                    {salsaConnect.address || salsaConnect.location} ·{" "}
                    <a
                      href={`https://www.instagram.com/${salsaConnect.venueHandle}`}
                      target="_blank"
                      rel="noopener noreferrer"
                      className="underline decoration-primary-foreground/40 hover:decoration-primary-foreground"
                    >
                      @{salsaConnect.venueHandle}
                    </a>
                  </p>
                  ...
                  <div className="flex flex-col sm:flex-row gap-3">
                    <CTAButton
                      ...
                      size="lg"
                    >
                      {salsaConnect.cta || "Book Tickets"}
                    </CTAButton>
                    <button
                      onClick={() => openModal(salsaConnect)}
                ...
                <div className="p-10 md:p-14 md:border-l border-primary-foreground/20 backdrop-blur-[1px]">
                  ...
                  <p className="font-serif-elegant italic text-xl md:text-2xl text-primary-foreground leading-relaxed mb-6">
                    If you're ready for deeper connection, put down your phone
                    and pick up a salsa partner.
                  </p>
                  <p className="font-body text-primary-foreground/90 leading-relaxed mb-4">
                    Come alone or bring a friend. You don't need to be a
                    "dancer" to come to this — you just need to be open.
                  </p>
                  <p className="font-body text-primary-foreground/90 leading-relaxed mb-4">
                    Because this isn't just about salsa. It's about connection.
                    To others. To your confidence. To that part of you that's
                    been waiting to come alive.
                  </p>
              ...
              <div className="relative grid md:grid-cols-[1.2fr_1fr] gap-0">
                <div className="p-10 md:p-12">
                  ...
                  <p className="font-body text-muted-foreground leading-relaxed mb-2">
                    {bachata.address || bachata.location} ·{" "}
                    <a
                      href={`https://www.instagram.com/${bachata.venueHandle}`}
                      target="_blank"
                      rel="noopener noreferrer"
                  ...
                  <div className="grid sm:grid-cols-2 gap-3 mb-8">
                    <div className="rounded-2xl border border-border/70 p-5 bg-warm-white">
                      ...
                      <p className="font-statement text-3xl text-primary mt-1">
                        £10
                      </p>
                    </div>
                    <div className="rounded-2xl border border-border/70 p-5 bg-warm-white">
                  ...
                  <div className="flex flex-col sm:flex-row gap-3">
                    ...
                    <button
                      onClick={() => openModal(bachata)}
                      className="inline-flex items-center justify-center gap-2 px-8 py-3.5 rounded-full font-body text-sm font-semibold tracking-[0.18em] uppercase text-primary hover:text-orange-700 transition-colors"
                    >
                      More info →
                    </button>
                  </div>
      ...
      <section className="relative py-24 px-6 text-center overflow-hidden bg-warm-gradient">
        <div
          ...
          style={{
            background:
              "radial-gradient(circle, hsl(var(--orange-200)), transparent 70%)",
          }}
        />
        <div
